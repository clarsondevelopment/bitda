...
class ImpactForm extends StatefulWidget {
  final String formUrl;

  const ImpactForm({super.key, required this.formUrl});

  @override
  State<ImpactForm> createState() => _FormPageState();
}

class _FormPageState extends State<ImpactForm> {
  ...
  Widget build(BuildContext context) {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                AppLocalizations.of(context)!.impactFormMenu,
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(AppLocalizations.of(context)!.impactTopMessage),
        centerTitle: true,
      ),
      body: Stack(
        children: [
